...
angular.module("wmodal_fmodal.html", []).run(["$templateCache", function($templateCache) {
	$templateCache.put("wmodal_fmodal.html", "<div class='modal m_viwer'><div class='modal_viewer '><i class='icon icon-close close-m' ng-click='close(); $root.bodyScrollHidden=false'></i><ng-transclude>This is the default content of the modal</ng-transclude></div></div>");
}]);
